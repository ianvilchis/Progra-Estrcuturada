...
void Inicializacion(int N, int M, int Tablero1[N][M], int Tablero2[N][M]);
...
void MostrarTablero(char Jugador[], int N, int M, int Tablero[N][M]);
...
void Disparos(char Jugador1[], char Jugador2[], int *impactos, int N, int M, int Tablero[N][M]);
